    ...
    return (
        <div style={styles.page}>
            ...
            {/* NAVBAR */}
                ...
                <h2 style={styles.nav}>{lang === "en" ? "Job Details." : "வேலை விவரங்கள்."}
                </h2>
            ...
            <div style={styles.container}>
                    ...
                    <div style={styles.card}>
                        ...
                        <div style={styles.infoRow}>
                            <div style={styles.iconBox}>
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0d6efd"
                                     strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                    <circle cx="12" cy="10" r="3"></circle>
                                </svg>
                        ...
                        <div style={styles.infoRow}>
                            ...
                            <div>
                                ...
                                <p style={styles.infoText}>{maskPhone(job.phone_number)}</p>
                ...
                <div style={styles.actionFooter}>
                    ...
                    {job.email && (
                        <a href="mailto:cholainfotech29@gmail.com" style={styles.emailBtn}>
                          Email
                        </a>
