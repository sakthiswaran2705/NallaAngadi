  ...
  return (
    <>
      ...
      >
        ...
        <p>
          These Terms & Conditions govern your use of the <b>NallaAngadi</b> website
        ...
        <p>
          NallaAngadi provides digital business listings, advertisements, and
        ...
        <h3>3. Payments</h3>
        <p>
          Payments made on NallaAngadi are processed through secure payment gateways.
        ...
        <p>
          All content, logos, and materials on NalllaAngadi are the property of NallaAngadi
          and may not be copied, reproduced, or distributed without prior
          written consent.
        </p>

        <h3>7. Limitation of Liability</h3>
        <p>
          NallaAngadi shall not be liable for any direct, indirect, or incidental
        ...
        <p>
          <b>Email:</b> nallaangadi2026@gmail.com <br />
          <b>Phone:</b> +91 8870462434 <br />
